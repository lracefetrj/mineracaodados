...
bfd_num.ad <- dplyr::select (bfd_num.dd, departure_delay, real_depart_hour, depart_temperature, depart_dew_point, real_arrival_date, real_arrival_hour, real_duration)

#Seleciona atributos de arrival_delay
bfd_num.ad <- dplyr::select (bfd_num.ad, arrival_delay, real_depart_hour, depart_humidity, depart_wind_direction, real_arrival_date, real_arrival_hour, real_duration, arrival_dew_point, arrival_wind_direction)
